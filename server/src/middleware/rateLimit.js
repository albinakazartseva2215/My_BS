...
const ROUTE_LIMITS = {
  ...
  // Вход через Яндекс (routes/auth.routes.js, GET /api/auth/yandex/start и
  // /yandex/callback) — тот же лимит, что и у login, чтобы не остаться
  // способом входа без ограничения частоты.
